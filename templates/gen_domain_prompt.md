...
生成後、各問を `templates/question.json` のスキーマ(`schema/question.schema.json` が正本)に従う **JSON オブジェクト 1 ファイル**として `study-log/{DOMAIN}/questions/<...>.json` に保存し、`CLAUDE.md`「ドメイン追加手順」に沿って state を初期化する。
